            ...
            >
              <div class="comment-item-box">
                <div class="head">
                  ...
                  <div class="name">
                    <a :class="{ 'admin-mark': item.admin }"
                      >{{ item.name
                      }}<span class="mark-tit" v-if="item.admin"
                        >这里有我，并且不止有我</span
                      ></a
                    >
                    <div class="r">
                    ...
                    <div class="head">
                      ...
                      <div class="name">
                        <a :class="{ 'admin-mark': items.admin }"
                          >{{ items.name
                          }}<span class="mark-tit" v-if="items.admin"
                            >这里有我，并且不止有我</span
                          ></a
                        >
                        <div class="r">
          ...
          if (res.data.status === 1) {
            ...
            setTimeout(() => {
              ...
              if (data.type === 1) {
                ...
                this.comment.data
                  .filter((i) => i.id === id)
                  .forEach((item) => item.child.push(data));
              }
              // Comment total +1
